<template >
  <div class="mv">
    <div class="mvvideo">
      ...
      >
        <div class="mvimg">
          <img :src="item.pic || mvDefaultImg" alt="" srcset="" />
...
export default {
  ...
  methods: {
    requestsonglist(page = 0) {
      ...
      //   page);
      axios({
        // http://search.kuwo.cn/r.s?all=%E6%88%91%E7%9A%84%E5%A4%A9%E7%A9%BA&pn=0&rn=100&ft=playlist&encoding=utf8&rformat=json&pay=0&needliveshow=0&ver=mbox&vipver=MUSIC_8.7.6.0_BDS4&plat=pc&devid=0
        // url: "http://search.kuwo.cn/r.s?all=%E6%88%91%E7%9A%84%E5%A4%A9%E7%A9%BA&pn=0&rn=100&ft=playlist&encoding=utf8&rformat=json&pay=0&needliveshow=0&ver=mbox&vipver=MUSIC_8.7.6.0_BDS4&plat=pc&devid=0",
        url:
          "http://120.24.51.158/kwmusic/backend/getsonglist.php?key=" +
          this.$route.query.key.split("#")[0] +
          "&page=" +
          page,
        headers: {},
