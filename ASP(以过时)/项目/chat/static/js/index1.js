...
login_btn.onclick=function(e){
                        ...
                        top_input_reslut.innerHTML=`
                            ...
                            $.ajax({          
                                ...
                                success:function(data2){
                                    ...
                                    //执行刷新好友成员列表
                                    //关闭所有定时器,定时器是按顺序的,最后定义的定时器就是自己定义的最后哪一个end
                                    let end = setInterval(function () { }, 10000);
                                    for (let i = 1; i <= end; i++) {
                                        clearInterval(i);
                                    }
                                    friend_content_update()
                                    alert(eval(data2)[1])
                                    }else{
                                        //已添加该好友,添加失败的提示
                                        alert(eval(data2)[1])
  ...
  function friend_content_update(){
      //关闭所有定时器,定时器是按顺序的,最后定义的定时器就是自己定义的最后哪一个end
      let end = setInterval(function () { }, 10000);
      for (let i = 1; i <= end; i++) {
              clearInterval(i);
                ...
                url="./static/asp/friendid.asp?myid="+eval(data)[1]  //loginadmin 数据
                    ...
                    success:function(data1){
                        ...
                        data11.forEach(function(item,index){
                    ...
                    success:function(data2){
                        ...
                        // 实时获取最新消息,改变成员最新消息
                            var time1group=setInterval(function(){
                             ...
                             setInterval(function(){
                                ...
                                url="./static/asp/search.asp?friendid="+item[1]
                                $.ajax({          
                                    url, 
                                type:"GET", 
                                async:"true",
                                success:function(data4){
                                    ...
                                    if(center_l_child.children[1].children[0].innerText.innerText!=eval(data4)[1]){
                                        console.log(center_l_child.children[1].children[0].innerText);
                                        console.log(eval(data4)[4]);
                                        
                                        center_l_child.children[1].children[0].innerText=eval(data4)[1]
                                    }
                                },
                                error:function(){
                                    console.log("获取好友昵称失败！");
                                }
                                })
                            },2000)  
                        ...
                        center_l_people.forEach((element,index) => {
                            ...
                            element.onclick=function(){
                                ...
                                //     console.log("清除定时器"+chat_content_update);
                                // }
                                //清除所有定时器
                                let end = setInterval(function () { }, 10000);
                                    for (let i = 1; i <= end; i++) {
                                ...
                                //生成新的定时器,将实时获取最新消息 重新使用
                                // 实时获取最新消息,改变成员最新消息
                                center_l_people.forEach((element1,index1) => {
                                    
                                    setInterval(function(){
                                        // console.log(element1);
                                        url="./static/asp/grouppeople.asp?myid="+item[0]+"&friendid="+element1.children[0].getAttribute("data")
                                        $.ajax({          
                                            url, 
                                        type:"GET", 
                                        async:"true",
                                    ...
                                    //    console.log(1);
                                            ...
                                            // console.log(data3);     //每个id 好对应的消息
                                            // console.log(center_l_child.children[1].children[1]);
                                            element1.children[1].children[1].innerText=eval(data3)[eval(data3).length-1][3]
                                        },
                                        error:function(){
                                            console.log("获取好友消息失败！");
                                        }
                                    ...
                                    setInterval(function(){
                                        // console.log(element1);
                                        url="./static/asp/search.asp?friendid="+element1.children[0].getAttribute("data")
                                        $.ajax({          
                                            url, 
                                        type:"GET", 
                                        async:"true",
                                        success:function(data4){
                                            // console.log(data4);     //每个id 好对应的消息
                                            if(element1.children[1].children[0].innerText!=eval(data4)[1]){
                                                console.log(element1.children[1].children[0].innerText);
                                                console.log(eval(data4)[4]);
                                                
                                                element1.children[1].children[0].innerText=eval(data4)[1]
                                            }
                                        },
                                        error:function(){
                                            console.log("获取好友昵称失败！");
...
let user_name=document.querySelector("body > div.main > div.top > div:nth-child(1) > span")
console.log(user_name);
user_name.onclick=function(){
    // this.contenteditable="true"  //无效
    console.log(1);
    this.setAttribute("contenteditable","true")
    user_name.onfocus=function(){
        console.log(2);
        console.log(user_name.innerHTML);
        if(user_name.innerHTML.length>10){
            user_name.innerHTML.substring(0,10)
        }
    }
    user_name.onblur=function(){
        console.log(3);
        url="./static/asp/namexiu.asp?myname="+user_name.innerHTML+"&myid="+eval(data)[1]
        $.ajax({          
            url, 
            type:"GET", 
            async:"true",
...
// 文件上传
// var getupload_btn=document.querySelector(".ball1 p")
// var upload_board=document.querySelector(".upload_board")
// var upload_board_upload=document.querySelector(".upload_board").children[0]
// getupload_btn.onclick=function(){
//     console.log(1);
// }
// upload_board_upload.onchange=function(){
//     console.log(this.files);
//     // console.log((this.files[0].size/1024/1024).toFixed(2)); //一个文件大小
//     // var fr = new FileReader();
//     // console.log(fr); 
//     //预览图片
//     // fr.onload = function() {
//     //     var before_upload_img=document.createElement("img")
//     //     before_upload_img.src=fr.result;
//     //     upload_board_upload.appendChild("before_upload_img")
//     // };
...
//          all_size+=parseFloat((this.files[i].size/1024/1024).toFixed(2))
...
//     console.log("文件总大小:"+all_size);
//     if(all_size>5){
//         alert("不能上传总和大于5M 的文件!")
//         return
//     }else{
//         console.log("正在提交...")
//         //提交至服务器
//         // $.ajax({
//         //     url: "./static/asp/upload.asp",
//         //     type: 'POST',
