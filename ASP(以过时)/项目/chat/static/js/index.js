...
//好友列表
function friend_content_update(data){
 ...
 //遍历所有好友成员
function friend_click(data,item) {
    // 成员/群名称
     ...
     center_l_people.forEach((element,index) => {
        ...
        element.onclick=function(){
            ...
            center_l_people.forEach((element1,index1) => {
                ...
                setInterval(function(){
                    // console.log(element1);
                    url="./static/asp/grouppeople.asp?myid="+eval(data)[1]+"&friendid="+element1.children[0].getAttribute("data")
                    $.ajax({          
                        url, 
                    type:"GET", 
                    async:"true",
                    success:function(data3){
                //    console.log(1);
                        // console.log("每个id 好对应的消息"+data3);     //每个id 好对应的消息
                        // console.log(center_l_child.children[1].children[1]);
...
chat_content_update=setInterval(function(){
        ...
        error:function(){
            console.log("获取好友消息失败！");
                        ...
                        center_r_button_text.onkeydown=function(e) {
                            if(e.keyCode==13){
                                //监听回车事件
                                // console.log(this.value);
                                center_r_button_btn.click()
                            }
                          }
