...
.field public static final APP_INFO_TRACK_URL:Ljava/lang/String; = "http://manager.channel.aliyun.com/tagAndroid.html"

.field public static final APP_Key:Ljava/lang/String; = "appKey"

.field public static final APP_TRACK_URL:Ljava/lang/String; = "http://manager.channel.aliyun.com/activeapp.html"
...
.field public static final KEY_OF_APP_INFO_TRACK_URL:Ljava/lang/String; = "APP_INFO_TRACK_URL"

.field public static final KEY_OF_APP_TRACK_URL:Ljava/lang/String; = "APP_TRACK_URL"
...
.field public static final RPC_HTTP_GATEWAY_FOR_PRE:Ljava/lang/String; = "http://gw.pre.channel.aliyun.com/g"
...
.field public static final SDK_VERSION:B = 0x12t
...
.field public static final SYSTEM_MSG:Ljava/lang/String; = "com.alibaba.cchannel.action.SYSTEM_MSG"
...
.method public static get_APP_INFO_TRACK_URL()Ljava/lang/String;
    .locals 2

    sget-object v0, Lcom/alibaba/cchannel/CloudChannelConstants;->b:Ljava/util/Map;

    const-string v1, "APP_INFO_TRACK_URL"
    ...
    const-string v1, "/tagAndroid.html"
    ...
    const-string v0, "http://manager.pre.channel.aliyun.com/tagAndroid.html"

    goto :goto_0

    :cond_2
    const-string v0, "http://manager.channel.aliyun.com/tagAndroid.html"

    goto :goto_0
.end method

.method public static get_APP_START_TRACK_URL()Ljava/lang/String;
    .locals 2

    sget-object v0, Lcom/alibaba/cchannel/CloudChannelConstants;->b:Ljava/util/Map;

    const-string v1, "APP_TRACK_URL"
    ...
    const-string v1, "/activeapp.html"
    ...
    const-string v0, "http://manager.pre.channel.aliyun.com/activeapp.html"

    goto :goto_0

    :cond_2
    const-string v0, "http://manager.channel.aliyun.com/activeapp.html"
...
.method public static get_CONFIG_FETCH_URL()Ljava/lang/String;
    ...
    const-string v0, "http://manager.pre.channel.aliyun.com/config.html"
...
.method public static get_RPC_HTTP_GATEWAY()Ljava/lang/String;
    ...
    const-string v0, "http://gw.pre.channel.aliyun.com/g"
...
.method public static get_SID_FETCH_URL()Ljava/lang/String;
    ...
    const-string v0, "http://manager.pre.channel.aliyun.com/sid.html"
