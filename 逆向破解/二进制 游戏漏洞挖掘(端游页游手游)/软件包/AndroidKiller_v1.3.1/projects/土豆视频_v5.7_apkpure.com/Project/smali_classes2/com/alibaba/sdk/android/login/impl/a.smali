.class public final Lcom/alibaba/sdk/android/login/impl/a;
...
# virtual methods
.method protected final onCallbackContext(IILandroid/content/Intent;Landroid/app/Activity;Ljava/util/Map;Landroid/webkit/WebView;)V
    .locals 6
    ...
    :try_start_0
    sget v3, Lcom/alibaba/sdk/android/system/RequestCode;->OPEN_H5_LOGIN:I
    ...
    iget v3, v1, Lcom/alibaba/sdk/android/message/Message;->code:I

    iget-object v1, v1, Lcom/alibaba/sdk/android/message/Message;->message:Ljava/lang/String;

    invoke-interface {v0, v3, v1}, Lcom/alibaba/sdk/android/login/callback/LoginCallback;->onFailure(ILjava/lang/String;)V
    ...
    :cond_2
    sget v3, Lcom/alibaba/sdk/android/system/RequestCode;->OPEN_TAOBAO:I
    ...
    invoke-static {v0, v2}, Lcom/alibaba/sdk/android/trace/AliSDKLogger;->d(Ljava/lang/String;Ljava/lang/String;)V

    :cond_5
    sget-object v0, Lcom/alibaba/sdk/android/login/impl/b;->b:Lcom/alibaba/sdk/android/login/impl/b;
...
.method protected final onTaeSDKActivity(IILandroid/content/Intent;Lcom/alibaba/sdk/android/webview/BaseWebViewActivity;Ljava/util/Map;Landroid/webkit/WebView;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(II",
    ...
    sget v0, Lcom/alibaba/sdk/android/system/RequestCode;->OPEN_H5_LOGIN:I
    ...
    invoke-static {v1, v0}, Lcom/alibaba/sdk/android/ResultCode;->create(I[Ljava/lang/Object;)Lcom/alibaba/sdk/android/ResultCode;
    ...
    :cond_2
    sget v0, Lcom/alibaba/sdk/android/system/RequestCode;->OPEN_TAOBAO:I
...
.method protected final onWebViewActivitySupport(IILandroid/content/Intent;Landroid/app/Activity;Lcom/alibaba/sdk/android/ui/support/OnActivityResultCallback;Landroid/webkit/WebView;)V
    .locals 4
