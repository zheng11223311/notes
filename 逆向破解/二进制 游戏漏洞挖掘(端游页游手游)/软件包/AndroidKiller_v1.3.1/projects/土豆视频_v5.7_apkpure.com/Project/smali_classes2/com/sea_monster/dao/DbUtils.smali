.class public Lcom/sea_monster/dao/DbUtils;
...
.method public static executeSqlScript(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)I
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/sea_monster/dao/DbUtils;->executeSqlScript(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Z)I
...
.method public static executeSqlScript(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Z)I
    ...
    .prologue
    .line 56
    invoke-static {p0, p2}, Lcom/sea_monster/dao/DbUtils;->readAsset(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    .line 61
    invoke-static {p1, v2}, Lcom/sea_monster/dao/DbUtils;->executeSqlStatementsInTx(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;)I
    ...
    invoke-static {v4}, Lcom/sea_monster/dao/DaoLog;->i(Ljava/lang/String;)I
    ...
    :cond_0
    invoke-static {p1, v2}, Lcom/sea_monster/dao/DbUtils;->executeSqlStatements(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;)I
...
.method public static executeSqlStatementsInTx(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;)I
    ...
    .line 72
    :try_start_0
    invoke-static {p0, p1}, Lcom/sea_monster/dao/DbUtils;->executeSqlStatements(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;)I
...
.method public static logTableDump(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/sea_monster/dao/DaoLog;->d(Ljava/lang/String;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static readAllBytes(Ljava/io/InputStream;)[B
    ...
    invoke-static {p0, v0}, Lcom/sea_monster/dao/DbUtils;->copyAllBytes(Ljava/io/InputStream;Ljava/io/OutputStream;)I
...
.method public static readAsset(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    :try_start_0
    invoke-static {v0}, Lcom/sea_monster/dao/DbUtils;->readAllBytes(Ljava/io/InputStream;)[B
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
