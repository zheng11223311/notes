...
.method public constructor <init>(IIJJJJJJIIJ)V
    ...
    .param p7, "totalOriginalBitmapSize"    # J
    .param p9, "totalTransformedBitmapSize"    # J
    .param p11, "averageOriginalBitmapSize"    # J
    .param p13, "averageTransformedBitmapSize"    # J
    .param p15, "originalBitmapCount"    # I
    .param p16, "transformedBitmapCount"    # I
    .param p17, "timeStamp"    # J
