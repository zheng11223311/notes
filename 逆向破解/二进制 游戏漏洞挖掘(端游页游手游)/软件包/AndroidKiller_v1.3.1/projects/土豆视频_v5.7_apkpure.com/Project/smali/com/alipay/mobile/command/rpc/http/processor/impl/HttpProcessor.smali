...
.method protected static a(Lcom/alipay/mobile/command/model/HttpUrlResponse;Lorg/apache/http/HttpResponse;)V
    ...
    invoke-virtual {p0, v4, v5}, Lcom/alipay/mobile/command/model/HttpUrlResponse;->setPeriod(J)V
...
.method protected a(Lorg/apache/http/HttpResponse;ILjava/lang/String;Lcom/alipay/mobile/command/rpc/http/TransportCallback;)Lcom/alipay/mobile/command/model/Response;
    ...
    const-string v3, "begin parse response,UNKONW, step6"
...
.method protected final a(Lorg/apache/http/HttpEntity;JLjava/io/OutputStream;Lcom/alipay/mobile/command/rpc/http/TransportCallback;)V
    ...
    iget-object v9, p0, Lcom/alipay/mobile/command/rpc/http/processor/impl/HttpProcessor;->b:Lcom/alipay/mobile/command/model/HttpUrlRequest;

    invoke-virtual {v9}, Lcom/alipay/mobile/command/model/HttpUrlRequest;->isCanceled()Z
    ...
    invoke-virtual {v0, v8, v10, v11}, Lcom/alipay/mobile/command/rpc/http/TransportCallback;->onProgressUpdate(Lcom/alipay/mobile/command/model/Request;D)V
    :try_end_1
    ...
    const-string v6, "read ResponseData Error."
    ...
    const-string v6, "HttpWorker Request Error!"
...
.method public call()Lcom/alipay/mobile/command/model/Response;
    ...
    const-string v3, "Rpc process httpException error."
    ...
    const-string v2, "HttpWorker finish request: "
    ...
    invoke-virtual {v0, v6, v7}, Lcom/alipay/mobile/command/rpc/http/HttpManager;->addConnectTime(J)V
    ...
    const-string v6, "HttpWorker finish execute request: "
    ...
    :try_end_3
    .catch Lcom/alipay/mobile/command/util/exception/HttpException; {:try_start_3 .. :try_end_3} :catch_0
    ...
    :try_end_5
    .catch Lcom/alipay/mobile/command/util/exception/HttpException; {:try_start_5 .. :try_end_5} :catch_0
    ...
    :try_end_7
    .catch Lcom/alipay/mobile/command/util/exception/HttpException; {:try_start_7 .. :try_end_7} :catch_0
    ...
    .catch Ljavax/net/ssl/SSLPeerUnverifiedException; {:try_start_7 .. :try_end_7} :catch_3
    .catch Ljavax/net/ssl/SSLException; {:try_start_7 .. :try_end_7} :catch_4
    .catch Lorg/apache/http/conn/ConnectionPoolTimeoutException; {:try_start_7 .. :try_end_7} :catch_5
    ...
    .catch Lorg/apache/http/NoHttpResponseException; {:try_start_7 .. :try_end_7} :catch_8
    .catch Lorg/apache/http/conn/HttpHostConnectException; {:try_start_7 .. :try_end_7} :catch_9
    ...
    const-string v3, "----ConnectionPoolTimeoutException"
    ...
    const-string v2, "ConnectionPoolTimeoutException"
    ...
    const-string v3, "----NoHttpResponseException"
    ...
    const-string v2, "NoHttpResponseException"
...
.method public processResponse(Lorg/apache/http/HttpResponse;Lcom/alipay/mobile/command/model/HttpUrlRequest;Lcom/alipay/mobile/command/rpc/http/TransportCallback;)Lcom/alipay/mobile/command/model/Response;
    ...
    const-string v3, "begin parse Response check status,"
