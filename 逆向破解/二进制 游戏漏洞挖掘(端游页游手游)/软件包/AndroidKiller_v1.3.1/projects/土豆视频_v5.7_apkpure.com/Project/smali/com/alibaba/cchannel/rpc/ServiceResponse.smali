...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/alibaba/cchannel/rpc/b;

    invoke-direct {v0}, Lcom/alibaba/cchannel/rpc/b;-><init>()V
...
.method public restore(ZLjava/lang/String;)V
    .locals 4
    ...
    :cond_2
    new-instance v1, Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;

    invoke-direct {v1, v0}, Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;-><init>([B)V

    invoke-static {v1}, Lcom/alibaba/cpush/codec/support/ProtocolUtils;->decodeVariableNumber(Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;)J
    ...
    invoke-virtual {v1}, Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;->get()B

    move-result v0

    iput-byte v0, p0, Lcom/alibaba/cchannel/rpc/ServiceResponse;->c:B

    invoke-virtual {v1}, Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;->remaining()I

    move-result v0

    if-lez v0, :cond_3

    invoke-static {v1}, Lcom/alibaba/cpush/codec/support/HeaderUtils;->decodeHeaders(Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;)Ljava/util/Map;
    ...
    invoke-virtual {v1, v0}, Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;->get([B)Lcom/alibaba/cpush/codec/support/DynamicByteBuffer;

    invoke-static {}, Lcom/alibaba/cchannel/rpc/ResourceMeta;->getInstance()Lcom/alibaba/cchannel/rpc/ResourceMeta;

    move-result-object v2

    iget-object v2, v2, Lcom/alibaba/cchannel/rpc/ResourceMeta;->resourceInfoManager:Lcom/alibaba/cchannel/registry/util/ResourceInfoManager;

    if-eqz v2, :cond_4

    invoke-virtual {v2, v0}, Lcom/alibaba/cchannel/registry/util/ResourceInfoManager;->fromByteAndSet([B)Lcom/alibaba/cchannel/registry/metainfo/Resource;
