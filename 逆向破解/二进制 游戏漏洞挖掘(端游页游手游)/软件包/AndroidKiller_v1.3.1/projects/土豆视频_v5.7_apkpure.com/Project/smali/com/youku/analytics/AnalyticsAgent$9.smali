.class Lcom/youku/analytics/AnalyticsAgent$9;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/youku/analytics/AnalyticsAgent;->playerEvent(Landroid/content/Context;Lcom/youku/analytics/data/PlayActionData$Builder;Ljava/lang/String;)V
.end annotation
...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;JLcom/youku/analytics/data/PlayActionData$Builder;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$appContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$userID:Ljava/lang/String;

    iput-wide p3, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$time:J

    iput-object p5, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$builder:Lcom/youku/analytics/data/PlayActionData$Builder;
...
.method public createAction()Lcom/youku/analytics/common/IOJson;
    ...
    iget-object v2, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$appContext:Landroid/content/Context;
    ...
    .line 383
    iget-object v5, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$userID:Ljava/lang/String;

    iget-wide v6, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$time:J
    ...
    new-instance v0, Lcom/youku/analytics/data/PlayerData;

    iget-object v2, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$builder:Lcom/youku/analytics/data/PlayActionData$Builder;
    ...
    .line 386
    iget-object v3, p0, Lcom/youku/analytics/AnalyticsAgent$9;->val$appContext:Landroid/content/Context;
    ...
    .line 384
    invoke-direct {v0, v2, v1}, Lcom/youku/analytics/data/PlayerData;-><init>(Lcom/youku/analytics/data/PlayActionData$Builder;Lcom/youku/analytics/data/ActionBaseData;)V

    .line 387
    .local v0, "action":Lcom/youku/analytics/data/PlayerData;
    return-object v0
.end method
