...
.method public bridge synthetic afterDecodeMessage(Lio/rong/imlib/model/Message;Lio/rong/imlib/model/MessageContent;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/rong/message/ImageMessageHandler;->afterDecodeMessage(Lio/rong/imlib/model/Message;Lio/rong/message/ImageMessage;)V

    return-void
.end method

.method public afterDecodeMessage(Lio/rong/imlib/model/Message;Lio/rong/message/ImageMessage;)V
    .locals 10
    .param p1, "message"    # Lio/rong/imlib/model/Message;
    .param p2, "model"    # Lio/rong/message/ImageMessage;
...
.method public bridge synthetic beforeEncodeMessage(Lio/rong/imlib/model/Message;Lio/rong/imlib/model/MessageContent;)Z
    ...
    .end local p2    # "x1":Lio/rong/imlib/model/MessageContent;
    invoke-virtual {p0, p1, p2}, Lio/rong/message/ImageMessageHandler;->beforeEncodeMessage(Lio/rong/imlib/model/Message;Lio/rong/message/ImageMessage;)Z
...
.method public beforeEncodeMessage(Lio/rong/imlib/model/Message;Lio/rong/message/ImageMessage;)Z
    .locals 23
    .param p1, "message"    # Lio/rong/imlib/model/Message;
    .param p2, "model"    # Lio/rong/message/ImageMessage;
    ...
    invoke-static/range {v19 .. v19}, Lio/rong/message/ImageMessageHandler;->obtainImageUri(Landroid/content/Context;)Landroid/net/Uri;
    ...
    sput v19, Lio/rong/message/ImageMessageHandler;->COMPRESSED_QUALITY:I
    ...
    sput v19, Lio/rong/message/ImageMessageHandler;->COMPRESSED_SIZE:I
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    .line 91
    :goto_0
    invoke-virtual/range {p2 .. p2}, Lio/rong/message/ImageMessage;->getThumUri()Landroid/net/Uri;
    ...
    :cond_0
    :goto_1
    invoke-virtual/range {p2 .. p2}, Lio/rong/message/ImageMessage;->getLocalUri()Landroid/net/Uri;
    ...
    sget v20, Lio/rong/message/ImageMessageHandler;->THUMB_COMPRESSED_SIZE:I
    ...
    sget v21, Lio/rong/message/ImageMessageHandler;->THUMB_COMPRESSED_SIZE:I
    ...
    sget v20, Lio/rong/message/ImageMessageHandler;->THUMB_COMPRESSED_QUALITY:I
    ...
    sget v20, Lio/rong/message/ImageMessageHandler;->COMPRESSED_SIZE:I
    ...
    :cond_6
    invoke-virtual/range {p2 .. p2}, Lio/rong/message/ImageMessage;->isFull()Z
    ...
    sget v21, Lio/rong/message/ImageMessageHandler;->COMPRESSED_SIZE:I
    ...
    sget v20, Lio/rong/message/ImageMessageHandler;->COMPRESSED_QUALITY:I
