...
.method private static b()V
    ...
    const-string v2, "config\u914d\u7f6e\u53c2\u6570:logSwitch:"

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-boolean v2, Lcom/alipay/mobile/command/util/ConfigSwitcher;->f:Z
    ...
    sget-wide v2, Lcom/alipay/mobile/command/util/ConfigSwitcher;->a:J
    ...
    const-string v2, ",TaskInterval:"

    aput-object v2, v0, v1

    const/4 v1, 0x5

    sget-wide v2, Lcom/alipay/mobile/command/util/ConfigSwitcher;->c:J
    ...
    const-string v2, ",retryRpcTimes:"

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget v2, Lcom/alipay/mobile/command/util/ConfigSwitcher;->d:I
    ...
    const-string v2, ",SyncNetworks:"

    aput-object v2, v0, v1

    const/16 v1, 0x9

    sget-boolean v2, Lcom/alipay/mobile/command/util/ConfigSwitcher;->b:Z
    ...
    const-string v2, ",rbtMaxTimes:"

    aput-object v2, v0, v1

    const/16 v1, 0xb

    sget v2, Lcom/alipay/mobile/command/util/ConfigSwitcher;->e:I
...
.method public static updateCfg(Lcom/alipay/mobile/command/api/model/ConfigInfoRes;)V
    ...
    const-string v3, "UpdatedConfigFlag:null|"
    ...
    invoke-static {v4, v5}, Lcom/alipay/mobile/command/util/ConfigSwitcher;->setTimeRepeattaskExpireMill(J)Z

    move-result v3

    if-nez v3, :cond_3

    const-string v3, "TaskInterval:"
    ...
    invoke-static {v4, v5}, Lcom/alipay/mobile/command/util/ConfigSwitcher;->setSysSynInterval(J)Z
    ...
    const-string/jumbo v4, "\u914d\u7f6e\u6570\u636e\u66f4\u65b0\u5f02\u5e38:"
    ...
    sput-wide v4, Lcom/alipay/mobile/command/util/ConfigSwitcher;->c:J
    ...
    :goto_3
    sput-wide v4, Lcom/alipay/mobile/command/util/ConfigSwitcher;->a:J
