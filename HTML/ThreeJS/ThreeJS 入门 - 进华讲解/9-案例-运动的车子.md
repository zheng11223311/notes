# 案例-运动的车子
 ...
 `ThreeJS 入门 - 进华讲解\代码\8-案例-运动的车子.html`
...
<body>
    ...
    <script>
        ...
        const wheel1=new THREE.Mesh(
            new THREE.BoxGeometry(0.2, 0.7, 0.7),
            material
        )
        ...
        for (let index = 0; index < n; index++) {
            ...
            mesh.position.x=Math.cos(Math.PI*2/n*index)*r
            mesh.position.y=Math.sin(Math.PI*2/n*index)*r
            circle.add(mesh)
        }
