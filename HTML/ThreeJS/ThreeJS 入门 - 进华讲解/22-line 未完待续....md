...
```js
  //  点 线 面(体)
        ...
        // 点
        // new THREE.Point(geometry,material)
        // 线
        ...
        const p3=new THREE.Vector3(0,1,1)
        const p4=new THREE.Vector3(1,1,1)
        // const points=[p1,p2]
        // const points=[p1,p2,p3]
        const points=[p1,p2,p3,p4]
         // BufferGeometry定义一个空的geometry  ,向其子属性setFromPoints 传入1个参数为点,2个参数为线,3个为面,每个参数都是三维的向量坐标
         const geometry=new THREE.BufferGeometry().setFromPoints(points)

        // 或者使用js 的32位浮点型数组 创建坐标
        // let n=10
        // let points =new Float32Array(n*3)  //创建 n*3 个长度,一个点有3个值,n个点 有3n
        ...
        // three setAttribute 以被放弃
        // geometry.setAttribute('position',new THREE.BufferAttribute(points,3))  //传入points 每个point 都是3个数
        // 定义线材质
        ...
        // 参数
        //  color 
        // linewidth 由webgl 底层控制,无法直接设置,属性无效
        //  linecap 圆角/直角 
        // linejoin 两条线的连线方式 /首尾相连/不连接/最开始和最尾部的相连,中间的线首尾相连
        //  vertexColor
        const material=new THREE.LineDashedMaterial({
            color:'gold',
            linewidth:20,
        })
        const liner=new THREE.Line(geometry,material)
        scene.add(liner)
```



`ThreeJS 入门 - 进华讲解\代码\20-line 未完待续....html`
