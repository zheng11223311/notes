 ...
 *
 * @param center     Center of Hilbert curve.	//曲线中心
 * @param size       Total width of Hilbert curve.	//曲线宽度
 * @param iterations Number of subdivisions.	//分支次数
 * @param v0         Corner index -X, -Z.		//转弯
