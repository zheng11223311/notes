    ...
    <div id="my-mv-table">
        <div class="mv-box">
            <div class="mv-content" v-for="item in dataList.value.abslist" :key="item.MP3RID">
                <div class="img">
                    <img :src="item.hts_MVPIC || 'https://tse1-mm.cn.bing.net/th/id/OIP-C.WvhXlHH4SK25FKGEDkafAgHaEo?pid=ImgDet&rs=1'"
                        alt="">
                </div>
                <div class="mask">
                    <div>
                        <span class="iconfont icon-24gl-playCircle" title="直接播放"
                            @click="playMv(item.MP3RID.slice(4))"></span>
                    </div>
