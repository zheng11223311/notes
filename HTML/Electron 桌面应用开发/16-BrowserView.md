文档:[BrowserView | Electron (electronjs.org)](https://www.electronjs.org/docs/latest/api/web-contents)
...
```js
 ...
 app.on('ready', () => { //生命周期函数,监听窗口准备
     ...
     console.log(view);
     // console.log( view.getBounds() );    //获取框架的大小,坐标
