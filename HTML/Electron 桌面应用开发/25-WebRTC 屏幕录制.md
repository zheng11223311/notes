文档:[MediaDevices.getDisplayMedia() - Web API 接口参考 | MDN (mozilla.org)](https://developer.mozilla.org/zh-CN/docs/Web/API/MediaDevices/getDisplayMedia)

此api 在electron 上录制屏幕时,会出现找不到设备,百度查找解决方案
...
<body>
    <button>点击打开摄像头</button>
    <button>点击录制屏幕</button>
    <video src=""></video>
    ...
    <script>
        ...
        btn.onclick=init //点击开始录屏,并显示摄像头所拍摄到的画面
        btn1.onclick=init1 //点击开始录制屏幕
    </script>
</body>
