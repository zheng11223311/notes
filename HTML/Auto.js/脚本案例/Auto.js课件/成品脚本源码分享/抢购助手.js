...
ui.layout(
    <drawer id="drawer" >
        <vertical>
            <appbar>
                <toolbar  id="toolbar" paddingTop="5dp" title="抢购助手" bg="#ff4040" />
            ...
            <viewpager id="viewpager">
                ...
                <Switch id="overlayService" text="悬浮窗权限" checked="{{auto.service != null}}" padding="8 8 8 8"textSize="15sp" /> 
				 <text textSize="14sp" textColor="#111111" margin="0 5" text="如果无障碍和悬浮窗提示未开启，可以关闭后重新尝试开启！抢购软件长期更新，一对一指导使用，请咨询打折日报APP在线客服。"/>
                ...
                <frame> 
                <vertical>
                <text textSize="14sp"  textColor="#ff0000" text="聚划算和百亿补贴BP链接获取，一对一指导使用，请咨询打折日报APP在线客服。" />
                <horizontal w="*" h="1sp" margin="0 10 0 20" bg='#ff4040'></horizontal>
...
ui.ceshi.on("check", (checked)=>{
    ...
    ui.emitter.on("options_item_selected", (e, item)=>{
        switch(item.getTitle()){
            case "关于":
                alert("关于", "一对一指导使用，版本更新请咨询打折日报APP在线客服");
                break;
            case "日志":
	...
	ui.menu.on("item_click", item =>{
         switch(item.title){
            case"加微信群":
            alert("添加微信", "微信：dzrbkf，添加好友，入群获取帮助");
                break;  
     }
    });
