...
var str路径详情网页源码 = http.get("https://ditu.amap.com/service/autoNavigat?usepoiquery=true&coor_need=true&rendertemplate=1&invoker=plan&engine_version=3&start_types=1&end_types=1&viapoint_types=1&policy2=0&fromX=" + str起点 + "&start_poiname=startpoint&toX=+" + str终点 + "&end_poiname=endpoint&viapoints=&viapoint_poiids=&viapoint_poinames=&viapoint_poitypes=&key=&callback=")
