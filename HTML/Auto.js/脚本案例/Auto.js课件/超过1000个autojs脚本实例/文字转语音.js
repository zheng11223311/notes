...
<body>
请输入：<input type="text" id="J_input" /><br/><br/>
<input type="button" id="J_btn" value="转化"/><br/><br/>
输出是：<span id="J_output">...</span>


<script>*/
ipt=dialogs.rawInput("输入汉字");
console.show();
var PinYin = {
    "a": "\u554a\u963f\u9515",
