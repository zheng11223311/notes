...
ui.layout(
    <vertical w="*"h="auto">
        ...
        <seekbar-layout id="s1" w="*" h="auto" text="微调频率Hz" range="20 2000" sum="500" onChang="setHz1"/>
        <seekbar-layout id="s1" w="*" h="auto" text="粗调频率Hz" range="0 18000" sum="0" onChang="setHz2"/>
...
var thread =  threads.start(function() {
    ...
    while (1) {
        if (isPlay) {
            var Hz=Hz1+Hz2;
    var audioData  =  new Mbyte(Hz?sampleRateInHz/Hz:512);
