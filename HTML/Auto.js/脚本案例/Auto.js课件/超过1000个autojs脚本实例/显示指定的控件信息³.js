...
/**
 *作者QQ: 1811588980
 *完成时间: 2019年6月12日 下午8:44:33
 *测试机型: vivo PD1813D
  *Auto.js版本: Pro 7.0.3-7
  *Android版本: 8.1.0
  *屏幕: 1080*2280
  *API: 27
 *备注: (仅限pro可用)在屏幕上显示悬浮窗中心十字所指示位置上最小的控件信息。
**/

if(String(app.autojs.versionName).indexOf("Pro")<0){
    setClip("https://pro.autojs.org/");
    toastLog("仅限Auto.js Pro可用。购买链接已复制");
    exit();
};
