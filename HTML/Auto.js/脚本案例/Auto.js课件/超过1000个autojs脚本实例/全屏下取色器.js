...
var window = floaty.window(
    <frame>
     <img src="http://img03.sogoucdn.com/app/a/100520146/71316125981b3b548da388527ac92f65" h="150" w="150" />
 
        <text id="action" text="点击取色,长按复制" color="#ffffff" bg="#00000000" h="150" w="150"/>
           </frame>
);
    ...
    switch(event.getAction()){
        ...
        case event.ACTION_MOVE:
            ...
            if(new Date().getTime() - downTime > 200){
                aaa=(window.action.getText());
                
                if(aaa!="复制成功"){
                setClip(aaa);
                window.action.setText("复制成功");
                window.action.color("#ff00ff");
                }
            }else{
