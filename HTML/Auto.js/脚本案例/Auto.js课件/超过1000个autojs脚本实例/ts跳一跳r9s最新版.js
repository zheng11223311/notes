...
function sc(str){
var url = "http://c1.ys168.com/f_ht/ajcx/lyd.aspx?cz=lytj&pdgk=0&pdgly=0&pdzd=0&tou=1&yzm=undefined&_dlmc=10389405&_dlmm= HTTP/1.1";
...
press(963,1588,time);//随便找一点可以操作的点进行精确时间点击
sleep(100);window.setPosition(-1000,-1000);sleep(900);//延时越长越稳定//点击完延时0.x秒，隐藏悬浮窗，避免挡截图
}//死循环，永不结束
