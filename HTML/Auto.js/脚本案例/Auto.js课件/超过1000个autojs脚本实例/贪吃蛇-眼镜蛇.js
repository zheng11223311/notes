...
ui.layout(
    ...
    <vertical align="top" margin="5">
       ...
       <text id="text" gravity="center" bg="#ffffff" h="430"color="#000000" size="8"></text>
     <linear>
    <vertical w="170">
    ...
    <vertical>
    <linear> 
    <button margin="0 0 0 0" h="60" w="60" id="ashang1" text="真"></button>
    <button margin="0 0 0 0" h="60" w="60" id="ashang" text="上"></button>
    <button margin="0 0 0 0" h="60" w="60" id="ashang2" text="是"></button>
    </linear>
          <linear>
    ...
    <button h="60" w="60" id="ayou" text="右"></button>
        ...
        <linear>
    <button margin="0 0 0 0" h="60" w="60" id="axia1" text="无"></button>
   <button margin="0 0 0 0" h="60" w="60" id="axia" text="下"></button>
    <button margin="0 0 0 0" h="60" w="60" id="axia2" text="聊"></button>
    </linear>
          </vertical>
    </linear>
    </vertical>
...
ui.ashang1.click(() => {x=-1;y=-1;});
ui.ashang2.click(() => {x=1;y=-1;});
ui.ayou.click(() => {x=1;y=0;});
ui.axia.click(() => {x=0;y=1;});
ui.axia1.click(() => {x=-1;y=1;});
ui.axia2.click(() => {x=1;y=1;});
