...
var mytime=new Date();
var start_r,start_c;
var times=mytime.getTime(),timee;
...
function showw(){
    ...
    for(var i=0;i<path.length;i++){
        ...
        for(var i=0;i<swipe_path.length-1;i++){
            swipe(swipe_path[i][0],swipe_path[i][1],swipe_path[i+1][0],swipe_path[i+1][1],120);
        }
        mytime=new Date();
        timee=mytime.getTime();
        toast("结束,耗时"+(timee-times)/1000+"秒");
}
