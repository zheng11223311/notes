...
// @updateTime: 2021-03-13 14:25:05
// ==/UserScript==
(function() {
	/*
	 * 自定义区域
	...
	// 解析接口菜单框展开的高度
	var developMenuHeight = 325;
	// 解析接口菜单框展开的速度（如果展开动画卡顿请设置0,单位是秒）
	var developMenuSecond = 0.2;
	// 解析接口（可多个）
	const parseInterfaces =["https://z1.m1907.cn/?jx=","https://jsap.attakids.com/?url=","https://jx.hao-zsj.cn/vip/?url=","https://vip.ikjiexi.top/?url=","https://jiexi.380k.com/?url=","https://www.1717yun.com/jiexi/?url=","https://www.kpezp.cn/jlexi.php?url=","https://vip.52jiexi.top/?url=","https://vip.ikjiexi.top/?url=","https://api.yueliangjx.com/?url=","https://jx.ap2p.cn/?url=","https://zy.aoxtv.com/?url=","https://api.fenglinys.net/?url=","https://api.80tvs.cn/m3u8.php?url="];
	/*
	 * 非自定义区域
	 * 以下代码勿动
	 * 以下代码勿动
...
// 楼上说的对，top指向最顶层框架的window对象，
// self指向当前框架的window对象。如果网页中没有iframe，
// 则top和self是同一个值，所以这段代码可以防止自己的网页被别人用iframe
// 的方式嵌入到其它网页中去。
	if (self != top) {
		return;
	}
